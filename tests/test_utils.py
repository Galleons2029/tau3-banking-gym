...
def test_data_dir_environment_variable():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with patch.dict(os.environ, {"TAU3_DATA_DIR": str(temp_data_dir)}):
            # Re-import to get the new DATA_DIR value
            import importlib

            import tau3.utils.utils

            importlib.reload(tau3.utils.utils)

            assert tau3.utils.utils.DATA_DIR == temp_data_dir
...
def test_data_dir_fallback_to_source():
    ...
    with patch.dict(os.environ, {}, clear=True):
        ...
        utils_file = Path(tau3.utils.utils.__file__)
        expected_source_dir = utils_file.parents[3] / "data"
        assert tau3.utils.utils.DATA_DIR == expected_source_dir
