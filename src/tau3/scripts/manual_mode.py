...
from tau3.run import get_options, load_task_splits, load_tasks
from tau3.utils.tools import is_functional_tool_call, parse_functional_tool_call
...
def main():
    ...
    welcome_text.append("Tau3 Manual Mode", style="bold green")
