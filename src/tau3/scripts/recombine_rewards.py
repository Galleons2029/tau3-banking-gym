...
Usage:
    python src/tau3/scripts/recombine_rewards.py <experiment_dir>

Example:
    python src/tau3/scripts/recombine_rewards.py data/tmp/gdrive/experiment_2025_01_22_v3_regular_openai_low_vad
"""
...
def recombine_results(experiment_dir: str, domain: str | None = None) -> None:
    ...
    for results_file in results_files:
        ...
        tasks_file = Path(f"data/tau3/domains/{domain_name}/tasks.json")
