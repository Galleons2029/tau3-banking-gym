...
Usage:
    python -m tau3.scripts.leaderboard.generate_schema [--check]
...
from tau3.scripts.leaderboard.submission import Submission
...
def generate_schema() -> str:
    ...
    raw["description"] = (
        ...
        "src/tau3/scripts/leaderboard/submission.py — do not edit by hand."
    )
