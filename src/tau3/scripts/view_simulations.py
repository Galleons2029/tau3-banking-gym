...
from tau3.data_model.tasks import Task, TaskIssue, TaskIssueStatus
from tau3.metrics.agent_metrics import compute_metrics, is_successful
from tau3.utils.display import ConsoleDisplay
...
def save_task_issue(
    ...
    """
    domain_data_dir = Path(DATA_DIR) / "tau3" / "domains" / domain
