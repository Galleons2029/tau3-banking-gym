...
DEFAULT_LLM_SYNTHESIS = "openai/GLM5.3-agentic-qs-h20"
...
# User-selected synthesis gateway; isolated from official-domain model defaults.
WORLDGEN_ROLLOUT_API_BASE = "http://10.39.62.231:9091/v1"
WORLDGEN_ROLLOUT_MODELS = ("openai/gemini-3.5-flash", "openai/GLM-5.3-Flash")
...
DEFAULT_LLM_HTTP_MAX_CONNECTIONS = 10
DEFAULT_LLM_HTTP_MAX_KEEPALIVE_CONNECTIONS = 5
