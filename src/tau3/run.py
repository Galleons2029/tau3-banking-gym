"""
tau3.run -- Entry point for running simulations.

Thin facade that delegates to the tau3.runner package. All simulation
...
from tau3.runner.batch import run_tasks as _run_tasks

# =============================================================================
# Deprecated shims -- these preserve the old flat-argument signatures from
# tau3.run so existing callers keep working. New code should use
