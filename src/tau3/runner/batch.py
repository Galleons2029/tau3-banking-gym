...
from tau3.runner.build import _build_env_kwargs, build_orchestrator
from tau3.runner.checkpoint import (
    create_checkpoint_fns,
    try_resume,
)
from tau3.runner.helpers import get_info, get_tasks, make_run_name
from tau3.runner.progress import StatusMonitor, run_with_retry
from tau3.runner.simulation import run_simulation
from tau3.runner.work import WorkQueue, WorkUnit, make_unit_id
from tau3.user.user_simulator import get_global_user_sim_guidelines
from tau3.utils.display import ConsoleDisplay, Text
from tau3.utils.llm_utils import llm_log_mode, set_llm_log_dir, set_llm_log_mode
...
def run_tasks(
    ...
    *,
    ...
    # processes execute. See tau3.runner.controller.
    workers = getattr(config, "workers", 0) or 0
    if workers > 0:
        from tau3.runner.controller import drive_batches
        ...
        ConsoleDisplay.console.print(
            ...
            "To review the simulations, run: [bold blue]tau3 view[/bold blue]"
        )
